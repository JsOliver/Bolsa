...
<!-- FOOTER -->
<div class="footer clearfix" style="position:static!important;bottom: -10!important;margin-top: 52px!important;">
    <div class="container">
        <div class="row">
    ...
    -->
            ...
            <div class="col-md-6 col-12">
                <div class="footerLink">
                    <h5>Onde Estamos</h5>
                    <div style="color:white; font-size:14px; float:left;padding-bottom: 5px;"><b>SÃO PAULO .:</b> CD Via Varejo 710 – Castanho, Jundiaí – SP.<br/></div>
                    <div style="color:white; font-size:14px; float:left;"><b>BELO HORIZONTE.:</b> Anel Rodoviário Celso Mello Azevedo, 3713 <br/><div style="text-align:right;"> Bairro Bonsucesso CEP.: 30622-213</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-12">
                <div class="footerLink">
                    ...
                    <div style="color:white; font-size:14px; float:left;">Telefones: (31) 3422-6739 / 3383-1063</div>
